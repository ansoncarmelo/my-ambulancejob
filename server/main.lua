...
RegisterNetEvent('mf-inventory:createambulanceStorage')
AddEventHandler('mf-inventory:createambulanceStorage', function(name)
	local inv = exports["mf-inventory"]:getInventory(name)
		if not inv then 
			exports['mf-inventory']:createInventory(name, 'inventory', 'ambulance', name, 5000.0, 50, {})
		end
end)
