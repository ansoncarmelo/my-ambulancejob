...
Citizen.CreateThread(function()
	while true do
		...
		if isDead then
			...
			EnableControlAction(0, 304, true)
		else
			Citizen.Wait(500)
		end
	end
...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(0)
		if isDead and IsControlPressed(0, 304) then
...
function SendDistressSignal()
	...
	TriggerServerEvent('Trackables:Notify','接到市民求助',GetEntityCoords(GetPlayerPed(-1)),'ambulance')
...
AddEventHandler('esx_ambulancejob:updateBlip', function()
	...
	if ESX.PlayerData.job and ESX.PlayerData.job.name == 'ambulance' then
		ESX.TriggerServerCallback('esx_society:getOnlFreeHongKonginePlayers', function(players)
